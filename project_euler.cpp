...
void euler018_update_row_values(const int num_values_in_current_row,
...
short euler018()
{
    ...
    for (int row = 1; row < num_rows; ++row) {
        euler018_update_row_values(num_values_in_current_row, begin_of_current_row, begin_of_prev_row);
...
{
    for (auto _ : state)
        benchmark::DoNotOptimize(euler018());
}
